...
?>
<?php 
$sqlQuery = "INSERT INTO post (postId , userId , title , post_type , image_path , text_body , date_created ) VALUES ('$thisPostId' , '$thisUserId' , '$thisTitle' , '$thisPost_type' , '$thisImage_path' , '$thisText_body' , '$thisDate_created' )";
